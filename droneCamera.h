...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat3 r = glm::mat3(glm::rotate(glm::mat4(1.0), angle, right));
            forward = r * forward;
            //right = r * right;
            up = r * up;
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat3 r = glm::mat3(glm::rotate(glm::mat4(1.0), angle, glm::vec3(0, 1, 0)));
            forward = r * forward;
            right = r * right;
            up = r * up;
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat3 r = glm::mat3(glm::rotate(glm::mat4(1.0), angle, forward));
            //forward = r * forward;
            right = r * right;
            up = r * up;
